...
![image.png](attachment:00d44b9e-69a8-4b2f-b8da-eef0fbb492d8:image.png)
...
> You can have this image as a mindmap to find what template is being used furtherly.
> 

![Source: [Portswigger](https://portswigger.net/research/server-side-template-injection)](attachment:10e61e64-c886-4c37-ba34-e2885caf3adf:screen-shot-2015-07-20-at-09-21-56.png)
...
Challenge link: https://play.picoctf.org/practice/challenge/482

![image.png](attachment:861f109a-f6d0-42a8-91b2-dd3e44a08177:image.png)

### Solution

The home page of the challenge site is like this with a simple file upload feature.

![image.png](attachment:dadd0cb7-60df-45fd-8dd9-94ffae3636ae:image.png)
...
![image.png](attachment:c5266c68-d724-441a-8f3a-bb0982caa9b7:image.png)
...
![image.png](attachment:b8e4a446-4505-42db-8e30-f0aab42c5b6e:image.png)

I downloaded that file and opened that heapdump file.

In the find section, enter picoCTF and you get the flag in that file.

![image.png](attachment:2f57f560-606a-4a80-b7c4-2ade4b0e9079:image.png)
...
![image.png](attachment:b225bcd6-f16a-490c-b5e4-a5301c552ca7:image.png)
...
![image.png](attachment:1cc633e0-5edc-4b85-b3ad-725b7d877bce:image.png)

based upon the hint, we may have to look at the cookie, use inspect to get here

![image.png](attachment:244fc6b8-b70a-41b2-a666-be74f616e98e:image.png)
...
![image.png](attachment:f4b21189-e2f0-4590-8001-e3648b5707d3:image.png)
...
```bash
for i in $(seq 1 100); do curl -s --cookie "name=$i"  http://mercury.picoctf.net:6418/check; done | grep "picoctf"
```
